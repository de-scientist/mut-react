            ...
            <div className="col-lg-10">
              <ul className="list-unstyled roles-list">
                ...
                <li data-aos="fade-up" data-aos-delay="200">
                  <i className="fas fa-check-circle me-3" />
                  Ensuring adherence to the MUTCU Constitution and operational
                  policies.
                </li>
                <li data-aos="fade-up" data-aos-delay="300">
                  <i className="fas fa-check-circle me-3" />
                  Presiding over all Executive Council meetings and general
                  Union meetings.
                </li>
                ...
                <li data-aos="fade-up" data-aos-delay="500">
                  <i className="fas fa-check-circle me-3" />
                  Fostering unity, spiritual growth, and accountability among
                  all executive members and ministries.
                </li>
              </ul>
            </div>
          </div>
