            ...
            <div className="card-body p-4">
              <form onSubmit={handleSubmit}>
                <div className="row g-4">
                  ...
                  <div className="col-md-6">
                    <label htmlFor="userRole" className="form-label fw-bold">
                      System Role
                    </label>
                    <select
                      id="userRole"
                ...
                {users.length === 0 ? (
                  ...
                  users.map((user) => (
                    <tr key={user.id}>
                      ...
                      <td>
                        <span
                          className={`badge rounded-pill px-3 py-2 ${user.isActive ? "bg-success-subtle text-success" : "bg-secondary-subtle text-secondary"}`}
                        >
