...
const BlogsManagement = () => {
  ...
  const handleFormat = (startToken: string, endToken = startToken) => {
    ...
    requestAnimationFrame(() => {
      textarea.focus()
      const newPos = selectionStart + startToken.length + (selectedText || 'text').length + endToken.length
      ...
      <header className="bg-primary-dark text-white py-4 shadow-sm sticky-top">
        <div className="container d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
          <div>
            ...
            <p className="mb-0 text-white-50">Create, edit, and publish blog posts.</p>
          </div>
          <div className="d-flex gap-2">
            <button className="btn btn-light btn-sm" onClick={() => loadBlogs(pagination?.page || 1)}>
          ...
          <div className="col-lg-5">
            <div className="admin-form-container shadow-sm">
              <div className="card-header d-flex justify-content-between align-items-center">
                <h5 className="mb-0">{editingId ? 'Edit Blog Post' : 'Create Blog Post'}</h5>
                {editingId && (
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit} className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    />
                    <small className="text-muted">Editable; must remain unique.</small>
                  </div>
                  <div className="col-md-6">
                  ...
                  <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                      <label className="form-label mb-0" htmlFor="content">Content</label>
                      <div className="btn-group btn-group-sm" role="group" aria-label="Formatting toolbar">
                        <button type="button" className="btn btn-outline-secondary" onClick={() => handleFormat('**', '**')}>
                          <strong>B</strong>
                        </button>
                        <button type="button" className="btn btn-outline-secondary" onClick={() => handleFormat('*', '*')}>
                          <em>I</em>
                  ...
                  <div className="col-12">
                    <ImageUpload
                      ...
                      onChange={(val) => setForm((prev) => ({ ...prev, featuredImage: val }))}
              ...
              <div className="card-body">
                <div className="d-flex flex-column flex-md-row gap-3 align-items-md-end justify-content-between">
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    ...
                    <button className="btn btn-brand btn-sm" onClick={() => loadBlogs(1)}>
                      Filter
                    </button>
                  </div>
                </div>
                      ...
                      <tr key={blog.id}>
                        ...
                        <td>
                          <span
                            className={`badge rounded-pill ${
                              blog.status === 'published' ? 'bg-success-subtle text-success' : 'bg-secondary-subtle text-secondary'
                            }`}
                          >
                            {blog.status}
                          </span>
                        ...
                        <td className="text-end">
                          <div className="btn-group btn-group-sm" role="group">
                            <button className="btn btn-outline-secondary" onClick={() => handleEdit(blog)}>
                              Edit
                            </button>
                            <button
              ...
              <div className="d-flex justify-content-between align-items-center mt-3">
                ...
                <div className="btn-group">
                  <button
                    ...
                    onClick={() => loadBlogs(Math.max(1, (pagination?.page || 1) - 1))}
                  >
                    Previous
                  </button>
                  <button
