...
const EventsManagement = () => {
  ...
  const handleToggleActive = async () => {
    ...
    try {
      ...
      setEvents(events.map((e) => (e.id === selectedEvent.id ? { ...e, isActive: !e.isActive } : e)))
      setShowModal(false)
      setSelectedEvent(null)
      ...
      <div className="container">
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5 gap-3">
          <div>
            ...
            <p className="text-muted mb-0">Schedule, update, and manage community activities.</p>
          </div>
            ...
            <div className="card-body p-4">
              <form onSubmit={handleSubmit}>
                <div className="row g-4">
                  ...
                  <div className="col-md-6">
                    <label htmlFor="eventDate" className="form-label fw-bold small text-uppercase">Date *</label>
                    <input
                      id="eventDate"
                      type="date"
                      className="form-control form-control-lg bg-light border-0"
                  ...
                  <div className="col-md-6">
                    <label htmlFor="eventTime" className="form-label fw-bold small text-uppercase">Time</label>
                    <input
                      id="eventTime"
                      type="time"
                      className="form-control form-control-lg bg-light border-0"
                  ...
                  <div className="col-md-6">
                    <label htmlFor="eventLocation" className="form-label fw-bold small text-uppercase">Location</label>
                    <input
                      id="eventLocation"
                      type="text"
                      className="form-control form-control-lg bg-light border-0"
                  ...
                  <div className="col-12">
                    <label htmlFor="eventDesc" className="form-label fw-bold small text-uppercase">Description</label>
                    <textarea
                      id="eventDesc"
                  ...
                  <div className="col-12">
                    <div className="form-check form-switch p-0 ps-5">
                      ...
                      />
                      <label className="form-check-label fw-medium ms-2" htmlFor="flexSwitchCheckChecked">
                ...
                <div className="d-flex gap-2 mt-4 pt-3 border-top">
                  <button type="submit" className="btn btn-primary px-4 py-2 rounded-pill shadow-sm" title="Save changes">
                    ...
                    <tr key={event.id}>
                      <td className="px-4">
                        <div className="d-flex align-items-center gap-3">
                          {event.imageUrl ? (
                            <img src={event.imageUrl} alt={event.title} className="rounded-3" style={{ width: '48px', height: '48px', objectFit: 'cover' }} />
                          ) : (
                            <div className="bg-light rounded-3 d-flex align-items-center justify-content-center" style={{ width: '48px', height: '48px' }}>✨</div>
                          )}
                          <div>
                      ...
                      <td>
                        <div className="small fw-medium text-dark d-flex align-items-center gap-1">
                          <Calendar size={14} className="text-primary" /> {new Date(event.date).toLocaleDateString()}
                        </div>
                        <div className="small text-muted d-flex align-items-center gap-1">
                      ...
                      <td>
                        <span className={`badge rounded-pill px-3 py-2 ${event.isActive ? 'bg-success-subtle text-success' : 'bg-secondary-subtle text-secondary'}`}>
                      ...
                      <td className="px-4 text-end">
                        <div className="d-flex justify-content-end gap-2">
                          ...
                          <button
                            ...
                            onClick={() => { setSelectedEvent(event); setAction('toggle'); setShowModal(true) }}
                          ...
                          <button
                            ...
                            onClick={() => { setSelectedEvent(event); setAction('delete'); setShowModal(true) }}
                            title="Delete Event"
