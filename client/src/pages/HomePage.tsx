...
const HomePage = () => {
  ...
  const coreValues = useMemo(
    () => [
      ...
      },
      {
        title: "Love",
        icon: "fas fa-heart",
        text: "Demonstrating God’s unconditional love through genuine fellowship and a welcoming heart for all.",
      },
      {
        title: "Hope",
        icon: "fas fa-lightbulb",
        text: "Being a source of hope through positive words, encouraging actions, and unwavering faith in uncertain times.",
      },
      {
        title: "Godliness",
        icon: "fas fa-church",
        text: "Striving for lives that honour and glorify God in all we do—personally and together as a Union.",
      },
      {
        title: "Accountability",
        icon: "fas fa-user-check",
        text: "Walking together in fellowship, support, and solidarity—being answerable to one another in our actions and decisions.",
      },
      {
        title: "Service",
        icon: "fas fa-hand-holding-heart",
        text: "Putting our faith into action by serving practical and spiritual needs within the university and beyond.",
      },
    ],
    [],
  );
  ...
  return (
    <div>
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              ...
              >
                ...
                <p className="lead mb-5">
                  Equipped in all aspects of life — united as one body, and
                  reaching out to non-believers within our community and beyond.
                </p>
                <div>
            ...
            <div className="carousel-item">
              ...
              >
                ...
                <p className="lead mb-5">
                  Murang&apos;a University of Technology Christian Union — a
                  Christ-centred family for discipleship, evangelism, mission
            ...
            <div className="carousel-item">
              ...
              >
                ...
                <p className="lead mb-5">
                  Join us for Bible study, prayer meetings, worship services,
                  fellowships, and trainings that build a grounded and fruitful
                  walk with Christ.
                </p>
                <div>
            ...
            <div className="carousel-item">
              ...
              >
                ...
                <p className="lead mb-5">
                  Cultivating Christ-centeredness among members to positively
                  impact the society.
                </p>
                <div>
                  <Link to="/about" className="btn btn-primary btn-lg me-3">
      ...
      {/* Join Us CTA Section */}
      <section
        className="join-us-cta-section py-5"
        style={{ backgroundColor: "#ff9700", color: "white" }}
      >
        <div className="container">
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-8 text-center" data-aos="zoom-in">
              ...
              <h2 className="display-5 mb-3" style={{ color: "white" }}>
                Ready to Join Us?
              </h2>
              <p
                className="lead mb-5"
              ...
              >
                Become part of the MUTCU family and experience discipleship,
      ...
      <section className="about-section py-5">
        <div className="container">
          ...
          >
            ...
            Christ-centred, student-led fellowship at MUT, affiliated with FOCUS
            Kenya. We exist to inspire love, hope, and godliness through
          ...
          <div className="row align-items-center">
            ...
            >
              ...
              <p>
                Raising a Christ-like family, equipped in all aspects of life,
                by encouraging unity as one body and reaching out to
                non-believers within our community and beyond.
              </p>

              <h3 className="section-subtitle mt-4">Our Vision</h3>
              <p>
                To be a model Christian union that cultivates
                Christ-centeredness among members to positively impact the
                society.
              </p>
          ...
          <div className="row mt-5">
            ...
            >
              ...
              <p className="text-muted">
                MUTCU is founded on the fundamental truths of Christianity: the
                unity of the Father, Son, and Holy Spirit; the sovereignty of
                God in creation and redemption; the divine inspiration and
                supreme authority of Scripture; the universal sinfulness of
                humanity; salvation through the sacrificial death of Jesus
                Christ; His bodily resurrection and ascension; and the work of
                the Holy Spirit in every believer. This doctrinal foundation
                unites our fellowship and guides our ministry.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="core-values-section py-5">
        <div className="container">
          ...
          <p
            className="text-center lead mb-5 text-white-50"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            Our values shape our culture, our leadership, and how we serve in
            MUT and beyond.
          </p>
      ...
      <section className="ministries-section py-5" data-aos="fade-up">
        <div className="container">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Find your place to grow and to serve — each ministry exists to build
            believers and reach others.
          </p>
      ...
      <section className="events-section py-5 bg-light">
        <div className="container">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            From our Sunday services and Friday fellowships — plan ahead and
            invite a friend.
          </p>
      ...
      <section className="prayer-section py-5" data-aos="fade-up">
        <div className="container">
          ...
          <p className="text-center lead mb-5">
            ...
            intercession. Submit your request confidentially.
          </p>
            ...
            <div className="carousel-inner">
              ...
              <div className="carousel-item">
                ...
                >
                  <i className="fas fa-quote-left fa-2x mb-3 text-orange" />
                  <p className="lead">
                    “Serving in ministry helped me grow in discipline,
                    accountability, and boldness for Christ.”
                  </p>
                  <p className="mt-4">
                    <strong>– MUTCU Member</strong>
                  </p>
              ...
              <div className="carousel-item">
                ...
                >
                  <i className="fas fa-quote-left fa-2x mb-3 text-orange" />
                  <p className="lead">
                    “The Word, prayer meetings, and mentorship shaped me
                    spiritually and gave me purpose in campus.”
                  </p>
                  <p className="mt-4">
                    <strong>– MUTCU Member</strong>
                  </p>
      ...
      <section className="gallery-section py-5" data-aos="fade-up">
        <div className="container">
          ...
          <p className="text-center lead mb-5">
            Moments from our fellowship, services, events, and outreach
            activities.
          </p>
      ...
      >
        <div className="container">
          ...
          <p className="text-center lead mb-5 text-50">
            Subscribe for updates on services, programs, devotionals, and
