    ...
    <div className="bible-study-ministry-page">
      ...
      >
        ...
        >
          <h1 className="display-3 mb-3">
            MUTCU Bible Study &amp; Training Ministry
          </h1>
          <p className="lead">
            Grounding Believers in God&apos;s Word and Building Spiritual
            Maturity
          </p>
        </div>
      </section>
          ...
          <div className="row align-items-center">
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p>
                  To facilitate the systematic spiritual growth of members
                  through the in-depth study of God&apos;s Word in small groups
                  and structured self-training programs.
                </p>
              </div>
              <div className="mb-4">
                <h5 className="text-secondary mb-3">Our Mission</h5>
                <p className="lead">
                  The Bible Study &amp; Training Ministry is dedicated to
                  deepening the faith of MUTCU members through rigorous
                  engagement with Scripture. We provide multiple pathways for
                  spiritual growth: small group Bible studies for community
                  learning, nurturing classes for new believers, the BEST-P
                  program for those wanting to develop Bible exposition skills,
                  and consistent Bible reading initiatives to foster a culture
              ...
              <div>
                ...
                <ul>
                  <li>
                    Providing quality Bible study guides and teaching materials
                  </li>
                  <li>
                    Training and mentoring effective Bible study group leaders
                  </li>
                  <li>
                    Promoting consistent personal Bible reading across the CU
                  </li>
                  <li>
                    Equipping members with skills in biblical exposition and
                    interpretation
                  </li>
                </ul>
              </div>
      ...
      <section className="py-5 bg-light sub-ministries-section">
        <div className="container">
          ...
          <p className="text-center lead mb-5">
            Four core programs designed for comprehensive spiritual growth
            through God&apos;s Word.
          </p>
          ...
          <div className="row">
            ...
            >
              <div className="sub-ministry-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>
                  Intimate settings for in-depth exploration of God&apos;s Word.
                  Our small groups provide weekly discussions using official
                  guides, enabling members to understand Scripture deeply and
            ...
            >
              <div className="sub-ministry-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>
                  Bible Exposition Self Training Program for those desiring
                  deeper skills in biblical interpretation and teaching. This
                  structured program trains potential leaders in expositive
            ...
            >
              <div className="sub-ministry-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>
                  A program dedicated to fostering daily personal Bible reading
                  habits among members. We provide structured reading plans,
                  devotional resources, and accountability partnerships to
                  sustain a culture of personal devotion.
                </p>
                <h6>Key Features:</h6>
                <ul>
      ...
      <section className="py-5 bg-white roles-responsibilities-section">
        <div className="container">
          ...
          <p className="text-center lead mb-5">
            The Bible Study &amp; Training Committee comprises dedicated leaders
            responsible for oversight of each program.
          </p>
              ...
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body">
                  ...
                  <p className="card-text small">
                    Provides oversight and educational leadership for the entire
                    committee. Responsible for the overall strategy and health
                    of small group Bible studies, oversight of BEST-P
                    administration, and championing a culture of consistent
            ...
            >
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body">
                  ...
                  <p className="card-text small">
                    Handles all administrative tasks including minutes,
                    communication, and financial management. Custodian of all
                    committee funds, documents, and assets. Serves as financial
            ...
            >
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body">
                  ...
                  <p className="card-text small">
                    Oversees small Bible study groups, issues study guides,
                    collects contributions, and tracks group meetings. Ensures
                    Bible study leaders are effective and well-trained. Oversees
                    the Monday Bible Study Review at 4:00 PM.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body">
                  ...
                  <p className="card-text small">
                    Ensures BEST-P classes run smoothly, selects quality
                    facilitators, manages group formations and assignments, and
                    coordinates the annual BEST-P graduation. Oversees proper
            ...
            >
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body">
                  ...
                  <p className="card-text small">
                    Develops and promotes strategic plans to encourage daily
                    personal Bible reading across the CU. Manages reading-plan
                    groups, shares devotional resources, tracks engagement, and
                    provides motivation.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-md-8 text-center" data-aos="zoom-in">
              <div className="card border-0 shadow-lg p-4">
                ...
                <p className="card-text text-muted">
                  ...
                  Bible Study &amp; Training Ministry, ensuring members are
                  equipped with deep knowledge of God&apos;s Word and committed
                  to consistent personal devotion.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-5" data-aos="zoom-in">
            ...
            <p className="lead text-white-50">
              Whether you want to deepen your knowledge of Scripture, grow
              spiritually through community, or develop teaching skills,
              there&apos;s a place for you in our ministry.
            </p>
          </div>
          <div className="row justify-content-center">
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-3" data-aos="zoom-in">
              ...
              <p className="text-center mt-3 small">
                <strong>Small Bible Study Groups</strong>
              </p>
            </div>
            <div
            ...
            >
              ...
              />
              <p className="text-center mt-3 small">
                <strong>Personal Reading Groups</strong>
              </p>
            </div>
            <div
              className="col-md-6 col-lg-3"
            ...
            >
              ...
              />
              <p className="text-center mt-3 small">
                <strong>Baptism Celebration</strong>
              </p>
            </div>
          </div>
        </div>
