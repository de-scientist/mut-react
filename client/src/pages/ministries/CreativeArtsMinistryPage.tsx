    ...
    <div className="creative-arts-page">
      ...
      >
        ...
        <div className="container position-relative" data-aos="fade-up" data-aos-duration="1000">
          ...
          <p className="lead">Inspiring Love, Hope &amp; Godliness Through Artistic Expression</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 mb-4 mb-lg-0" data-aos="fade-right" data-aos-delay="100">
              ...
              <p className="lead">
                The Creative Arts Ministry (CREAM) is a vibrant and diverse ministry dedicated to using artistic expression to glorify
                God and communicate the gospel. We believe that creativity is a divine gift, and we use various mediums like drama,
                dance, and spoken word to inspire, edify, and engage the MUTCU community and beyond.
              </p>
              <p>
                CREAM plays a vital role in our union&apos;s outreach and internal events, often collaborating with the Music Ministry
                to create powerful and memorable worship experiences. Our mission is to raise up a generation of creative worshippers
                who use their talents for God&apos;s kingdom.
              </p>
            </div>
      ...
      <section className="py-5 bg-light creative-ensembles-section">
        <div className="container">
          ...
          <p className="text-center lead mb-5">
            CREAM is a home for all forms of artistic expression including drama, dance, spoken word, and modeling.
          </p>
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
              <div className="creative-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>The Dance ministry uses choreographed movements to praise and worship God, creating a dynamic and expressive form of prayer.</p>
            ...
            <div className="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
              <div className="creative-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>Our drama team presents powerful performances that communicate biblical truths and Christian values through theatrical expression.</p>
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
              <div className="creative-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>Using poetry and spoken word to express faith, share testimonies, and inspire the community with powerful words.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-5 cta-section text-white">
        <div className="container text-center" data-aos="zoom-in">
          ...
          <p className="lead mb-4 text-white-50">Express your faith through creativity and artistic talent.</p>
