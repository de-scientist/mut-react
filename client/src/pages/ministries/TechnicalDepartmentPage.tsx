          ...
          <div className="row align-items-center">
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p>
                  To provide excellent and seamless technical and media support
                  for all CU activities and to manage the Union's digital
              ...
              <div className="mb-4">
                ...
                <p className="lead">
                  The Technical &amp; Media Ministry ensures that all technical
                  aspects of MUTCU's services and events—including sound,
                  visuals, live streaming, publicity, and digital
                  communication—are executed with excellence, supporting the
                  worship experience and enhancing our outreach impact.
                </p>
              </div>
              <div>
                ...
                <ul>
                  ...
                  <li>
                    Ensuring consistent and positive brand identity online
                  </li>
                  <li>Training and equipping technical volunteers</li>
                  <li>
                    Supporting worship, events, and evangelism through excellent
                    technical service
                  </li>
                </ul>
              </div>
      ...
      <section className="py-5 bg-light sub-ministries-section">
        <div className="container">
          <h2 className="section-title text-center">
            Our Technical Sub-Ministries
          </h2>
          <p className="text-center lead mb-5">
            The ministry comprises four specialized sub-committees, each with
            distinct technical responsibilities.
          </p>
          <div className="row">
            <div
            ...
            >
              <div className="sub-ministry-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>
                  Manages all audio equipment, sound engineering, sermon
                  recording, and technician training for services and events.
                </p>
            ...
            >
              <div className="sub-ministry-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>
                  Leads the ushering team, creates a welcoming atmosphere,
                  manages seating, and oversees offering collection during
                  services.
                </p>
                <h6>Responsibilities:</h6>
                <ul className="small">
            ...
            >
              <div className="sub-ministry-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>
                  Publicizes all CU events, maintains publicity assets, and
                  ensures consistent brand communication and promotion.
                </p>
                <h6>Responsibilities:</h6>
                <ul className="small">
            ...
            >
              <div className="sub-ministry-card p-4 rounded-3 shadow-sm h-100">
                ...
                <p>
                  Manages website, social media platforms, live streaming
                  operations, and digital content creation for the CU.
                </p>
                <h6>Responsibilities:</h6>
                <ul className="small">
      ...
      <section className="py-5 cta-section text-white">
        <div className="container text-center" data-aos="zoom-in">
          ...
          <p className="lead mb-4 text-white-50">
            If you have technical skills or passion for supporting ministry
            through sound, visuals, digital media, or hospitality, we invite you
            to join our team.
          </p>
