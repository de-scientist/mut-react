          ...
          <div className="row align-items-center">
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p>
                  To strengthen MUTCU through meaningful engagement with alumni
                  and associates, fostering mentorship, resource support, and
                  long-term partnership that benefits both the Union and its
                  graduates.
                </p>
              </div>
              <div className="mb-4">
                ...
                <p className="lead">
                  The Associates Committee connects MUTCU with its alumni
                  community, creating pathways for mentorship, professional
                  networking, and resource mobilization. We celebrate the
                  ongoing impact of graduates and facilitate their continued
                  investment in the Union's mission.
                </p>
              </div>
              <div>
                ...
                <ul>
                  <li>
                    Building and maintaining relationships with MUTCU alumni
                  </li>
                  <li>Organizing alumni engagement events and reunions</li>
                  <li>
                    Facilitating mentorship programs connecting alumni with
                    current members
                  </li>
                  <li>Mobilizing resources and support from alumni networks</li>
                  <li>
                    Creating professional development and networking
                    opportunities
                  </li>
      ...
      <section className="py-5 bg-light roles-responsibilities-section">
        <div className="container">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            The Associates Committee builds bridges between MUTCU and its alumni
            community.
          </p>
            ...
            <div className="col-lg-10">
              <ul className="list-unstyled roles-list">
                ...
                <li data-aos="fade-up" data-aos-delay="200">
                  <i className="fas fa-check-circle me-3" />
                  Organizing and coordinating alumni events, reunions, and
                  networking sessions
                </li>
                <li data-aos="fade-up" data-aos-delay="300">
                  <i className="fas fa-check-circle me-3" />
                  Facilitating mentorship programs connecting alumni expertise
                  with current members
                </li>
                <li data-aos="fade-up" data-aos-delay="400">
                  <i className="fas fa-check-circle me-3" />
                  Coordinating resource mobilization efforts and fundraising
                  through alumni networks
                </li>
                <li data-aos="fade-up" data-aos-delay="500">
                  <i className="fas fa-check-circle me-3" />
                  Engaging alumni in strategic planning and long-term Union
                  vision
                </li>
                <li data-aos="fade-up" data-aos-delay="600">
                  <i className="fas fa-check-circle me-3" />
                  Showcasing alumni achievements and career pathways as
                  inspiration to current members
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-5 cta-section text-white">
        <div className="container text-center" data-aos="zoom-in">
          <h2 className="section-title text-white mb-4">
            Connect With Your MUTCU Family
          </h2>
          <p className="section-subtitle mb-5">
            Alumni engagement strengthens MUTCU's legacy and impact for future
            generations.
          </p>
          <div>
            <Link
